...
**Passo 1 (analista-de-requisitos):** Leia o arquivo fornecido pelo usuário e crie as Histórias de Usuário e o contrato de API. Salve o resultado final estruturado em `./docs/api.json`.
**Passo 2 (arquiteto-de-software):** Baseado no Passo 1, crie o schema PostgreSQL e o ADR. Salve o SQL e as documentações das tabelas na pasta `./`.
**Passo 3 (desenvolvedor-backend):** Baseado nos Passos 1 e 2, crie o código Node.js/Express completo. Analise o que já está na pasta `./erros-logica/` e corrija. Salve os novos arquivos em `./`.
**Passo 4 (tech-lead):** Avalie todo o processo e as falhas prevenidas. Gere o Markdown de changelog final e memória técnica. Salve em `./docs/historico.md`.
