...
4. Ler e analisar a pasta `../front/erros-logica/` (onde o agente de Backend pode ter reportado bugs nas suas páginas). Se houver análises lá, corrija seu código imediatamente.
5. Analisar proativamente o código na pasta `./` para identificar erros lógicos na API que estão te impedindo de consumir os dados corretamente. Escreva o relatório desses erros no arquivo `./erros-logica/erros-frontend-analise.txt`.
...
- TODOS os arquivos gerados devem ser salvos OBRIGATORIAMENTE dentro do diretório `../front/` na raiz do seu workspace (ex: `../front/src/app/page.jsx`). NUNCA salve dentro de uma pasta chamada `artefatos/`.
...
```jsx
// Exemplo: ../front/src/app/empresas/page.jsx
"use client";
